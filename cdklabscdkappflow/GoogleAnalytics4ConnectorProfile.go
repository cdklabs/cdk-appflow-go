...
// The jsii proxy struct for GoogleAnalytics4ConnectorProfile
type jsiiProxy_GoogleAnalytics4ConnectorProfile struct {
	jsiiProxy_ConnectorProfileBase
}

func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Credentials() awssecretsmanager.ISecret {
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_GoogleAnalytics4ConnectorProfile) Stack() awscdk.Stack {
...
func NewGoogleAnalytics4ConnectorProfile(scope constructs.Construct, id *string, props *GoogleAnalytics4ConnectorProfileProps) GoogleAnalytics4ConnectorProfile {
	...
	if err := validateNewGoogleAnalytics4ConnectorProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func GoogleAnalytics4ConnectorProfile_FromConnectionProfileArn(scope constructs.Construct, id *string, arn *string) GoogleAnalytics4ConnectorProfile {
	...
	if err := validateGoogleAnalytics4ConnectorProfile_FromConnectionProfileArnParameters(scope, id, arn); err != nil {
		panic(err)
	}
	var returns GoogleAnalytics4ConnectorProfile
...
func GoogleAnalytics4ConnectorProfile_FromConnectionProfileName(scope constructs.Construct, id *string, name *string) GoogleAnalytics4ConnectorProfile {
	...
	if err := validateGoogleAnalytics4ConnectorProfile_FromConnectionProfileNameParameters(scope, id, name); err != nil {
		panic(err)
	}
	var returns GoogleAnalytics4ConnectorProfile
...
func GoogleAnalytics4ConnectorProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateGoogleAnalytics4ConnectorProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func GoogleAnalytics4ConnectorProfile_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateGoogleAnalytics4ConnectorProfile_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func GoogleAnalytics4ConnectorProfile_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateGoogleAnalytics4ConnectorProfile_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) BuildConnectorProfileCredentials(props *ConnectorProfileProps) *awsappflow.CfnConnectorProfile_ConnectorProfileCredentialsProperty {
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) BuildConnectorProfileProperties(props *ConnectorProfileProps) *awsappflow.CfnConnectorProfile_ConnectorProfilePropertiesProperty {
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) GeneratePhysicalName() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) GetResourceNameAttribute(nameAttr *string) *string {
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) ToString() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleAnalytics4ConnectorProfile) TryAddNodeDependency(scope constructs.IConstruct, resource interface{}) {
